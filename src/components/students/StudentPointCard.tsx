...
const SIZE_CONFIG = {
  ...
  medium: {
    avatar: 'w-12 h-12 text-lg sm:w-16 sm:h-16 sm:text-xl',
    padding: 'p-2.5 sm:p-4',
    name: 'text-xs sm:text-sm',
    points: 'text-lg sm:text-xl',
    today: 'text-[10px] sm:text-[11px]',
    badge: 'text-[10px] px-1.5 py-0',
    gap: 'mt-2 sm:mt-3',
  },
  large: {
    avatar: 'w-14 h-14 text-xl sm:w-20 sm:h-20 sm:text-2xl',
    padding: 'p-3 sm:p-5',
    name: 'text-sm sm:text-base',
    points: 'text-xl sm:text-2xl',
    today: 'text-[11px] sm:text-xs',
