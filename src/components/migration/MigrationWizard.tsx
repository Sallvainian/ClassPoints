...
export function MigrationWizard({ onComplete, onSkip }: MigrationWizardProps) {
  ...
  if (step === 'check') {
    if (!hasData) {
      return (
        <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
          <div className="text-center">
            <div className="w-16 h-16 bg-green-100 dark:bg-green-900/40 rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-3xl">✨</span>
            </div>
            <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-50 mb-2">Welcome!</h2>
    ...
    return (
      <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-50 mb-2">Data Migration</h2>
          <p className="text-gray-600 dark:text-zinc-400 mb-6">
          ...
          <button
            onClick={onSkip}
            className="text-sm text-gray-500 dark:text-zinc-500 hover:text-gray-700"
          >
  ...
  if (step === 'preview') {
    return (
      <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        <h2 className="text-xl font-bold text-gray-900 dark:text-zinc-50 mb-4">
          Migration Preview
        </h2>
        ...
        <div className="bg-gray-50 dark:bg-zinc-900 rounded-lg p-4 mb-6 space-y-3">
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-zinc-400">Classrooms</span>
            <span className="font-semibold">{summary.classrooms}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-zinc-400">Students</span>
            <span className="font-semibold">{summary.students}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-zinc-400">Custom Behaviors</span>
            <span className="font-semibold">{summary.behaviors}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-600 dark:text-zinc-400">Point Transactions</span>
            <span className="font-semibold">{summary.transactions}</span>
          </div>
        </div>

        <div className="bg-yellow-50 dark:bg-yellow-950/40 border border-yellow-200 dark:border-yellow-900/50 rounded-lg p-3 mb-6">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full text-sm text-gray-500 dark:text-zinc-500 hover:text-gray-700"
          >
            Go Back
          </button>
        </div>
    ...
    return (
      <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 dark:text-zinc-500 mt-2">{progress.message}</p>
        </div>

        <div className="text-center text-gray-500 dark:text-zinc-500 text-sm">
  ...
  if (step === 'complete' && result) {
    return (
      <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        ...
        <div className="bg-gray-50 dark:bg-zinc-900 rounded-lg p-4 mb-6 space-y-2">
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-600 dark:text-zinc-400">Classrooms migrated</span>
            <span className="font-semibold text-green-600 dark:text-green-400">
              {result.classroomsMigrated}
            </span>
          </div>
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-600 dark:text-zinc-400">Students migrated</span>
            <span className="font-semibold text-green-600 dark:text-green-400">
              {result.studentsMigrated}
            </span>
          </div>
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-600 dark:text-zinc-400">Behaviors migrated</span>
            <span className="font-semibold text-green-600 dark:text-green-400">
              {result.behaviorsMigrated}
            </span>
          </div>
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-600 dark:text-zinc-400">Transactions migrated</span>
            <span className="font-semibold text-green-600 dark:text-green-400">
  ...
  if (step === 'error' && result) {
    return (
      <div className="max-w-md mx-auto p-6 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        ...
        <div className="bg-gray-50 dark:bg-zinc-900 rounded-lg p-4 mb-6 space-y-2">
          <p className="text-sm text-gray-600 dark:text-zinc-400">Partial migration results:</p>
          <div className="flex justify-between items-center text-sm">
            <span className="text-gray-600 dark:text-zinc-400">Classrooms</span>
